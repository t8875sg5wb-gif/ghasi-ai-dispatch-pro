...
export const Route = createFileRoute("/prognosen")({
  head: () => ({
    meta: [
      { title: "Prognosen – GHASI AI" },
      {
        name: "description",
        content:
          "Predictive AI von GHASI AI: Prognosen zu Umsatz, Auslastung, Fahrer- und Wartungsbedarf, Kraftstoff und saisonaler Nachfrage.",
      },
    ],
  }),
  component: PrognosenPage,
});

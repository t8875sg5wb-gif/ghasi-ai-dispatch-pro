...
export interface Auftrag {
  id: string;
  nummer: string;
  /** Angezeigter Patientenname (abgeleitet, sobald `patientId` gesetzt ist). */
  patient: string;
  /** Stabile Patienten-Zuordnung (patients.id); null = nicht verknüpft. */
...
export const SEED_AUFTRAEGE: Auftrag[] = [
  {
    ...
    prioritaet: "normal",
    status: "neu",
    abholort: "Pflegeheim Sonnenhof, Minden",
    zielort: "Dialysezentrum Nord, Minden",
  ...
  },
  {
    ...
    prioritaet: "normal",
    status: "unterwegs",
    abholort: "Privatadresse Bad Oeynhausen",
  ...
  },
  {
    ...
    abholort: "Pflegeheim Lindenhof, Minden",
